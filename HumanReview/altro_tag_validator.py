...
sys.path.append(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'TAGS'))
...
from connettore_mongo import ConnettoreMongoDB
...
class AltroTagValidator:
    ...
    def __init__(self, tenant_id: str, similarity_threshold: float = 0.9):
        ...
        self.tag_manager = TagManager(tenant_id)
        self.embedder = LaBSEEmbedder()
        self.db_connector = ConnettoreMongoDB()
