...
class EndToEndPipeline:
    ...
    def allena_classificatore(self,
        ...
        print(f"\n🔧 VERIFICA CONFIGURAZIONE BERTOPIC:")
        print(f"   📋 BERTopic enabled: {self.bertopic_config.get('enabled', False)}")
        print(f"   📋 BERTopic available: {_BERTopic_AVAILABLE}")
        print(f"   📋 Use SVD: {self.bertopic_config.get('use_svd', False)}")
        print(f"   📋 SVD components: {self.bertopic_config.get('svd_components', 32)}")
        print(f"   📋 Top-k topics: {self.bertopic_config.get('top_k', None)}")
        ...
        if self.bertopic_config.get('enabled', False):
            if not _BERTopic_AVAILABLE:
                ...
                try:
                    print("🚀 AVVIO TRAINING BERTOPIC:")
                    print(f"   📊 Testi da analizzare: {len(session_texts)}")
                    ...
                    print("   🔥 Esecuzione bertopic_provider.fit()...")
                    ...
                    print("   🔄 Esecuzione bertopic_provider.transform()...")
