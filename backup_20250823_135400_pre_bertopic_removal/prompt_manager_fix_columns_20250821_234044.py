...
class PromptManager:
    ...
    def create_prompt(self,
        ...
        try:
            ...
            query = """
            INSERT INTO prompts (tenant_id, tenant_name, prompt_type, content, variables, is_active, created_at, updated_at)
    ...
    def update_prompt(self, 
        ...
        try:
            ...
            if cursor.rowcount > 0:
                ...
                # Prima recupera i dati correnti
                history_query = """
                INSERT INTO prompt_history 
                SELECT id, tenant_id, engine, prompt_type, prompt_name, 
                       content, variables, is_active, NOW() 
