...
# Configurazione per VS Code tunneling e proxy
@app.after_request
...
@cross_origin(origins="*", methods=["GET"], allow_headers=["Content-Type", "Authorization", "X-Requested-With"])
...
@cross_origin(origins="*", methods=["POST"], allow_headers=["Content-Type", "Authorization", "X-Requested-With"])
def create_tool():
    """
    Crea un nuovo tool
...
@cross_origin(origins="*", methods=["PUT"], allow_headers=["Content-Type", "Authorization", "X-Requested-With"])
...
@cross_origin(origins="*", methods=["DELETE"], allow_headers=["Content-Type", "Authorization", "X-Requested-With"])
